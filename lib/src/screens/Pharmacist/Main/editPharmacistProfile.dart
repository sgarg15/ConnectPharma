...
class _EditPharmacistProfileState extends State<EditPharmacistProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        context.read(pharmacistSignUpProvider.notifier).changeSoftwareList([]);
        context.read(pharmacistSignUpProvider.notifier).changeSkillList([]);
        context.read(pharmacistSignUpProvider.notifier).changeLanguageList([]);
        return true;
      },
      child: Scaffold(
        appBar: AppBar(
