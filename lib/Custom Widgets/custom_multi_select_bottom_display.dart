...
class CustomMultiSelectBottomSheet<V> extends StatefulWidget
...
class _MultiSelectBottomSheetState<V>
    extends State<CustomMultiSelectBottomSheet<V>> {
  ...
  Widget _buildChipItem(MultiSelectItem<V> item) {
    ...
    print("Containes: ${_selectedValues.contains(item.value.toString())}");
    ...
    return Container(
      ...
      child: ChoiceChip(
        ...
        label: Text(
          item.label,
          style: _selectedValues
                  .any((element) => element.toString() == item.value.toString())
              ? TextStyle(
